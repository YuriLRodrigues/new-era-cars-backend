...
class FindAd {
  ...
  @ApiProperty({
    ...
    description: 'O identificador único para a imagem em miniatura',
  })
  @IsString()
  @IsNotEmpty()
  thumbnailId: string;
...
export class FindById200DTO {
  @ApiProperty({
    example: FindAd,
    description: 'A resposta do anúncio encontrado',
  })
  @Type(() => FindAd)
  response: FindAd;
  ...
  @ApiProperty({
    example: 'Advertisement found successfully',
